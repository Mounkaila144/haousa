"""Chargeur et modèle validé du lexique numérique hausa.
...
#: Vocabulaire de statut autorisé (aligné sur docs/numeration-hausa-v1.md).
...
@dataclass(frozen=True)
class Operator:
    """Opérateur arithmétique : symbole + forme hausa prononcée (story 6.1).
...
@dataclass(frozen=True)
class Lexicon:
    """Modèle chargé et validé du lexique numérique hausa.
