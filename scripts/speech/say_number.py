#!/usr/bin/env python
"""Restitution vocale hausa par concaténation — ligne de commande (story 6.1, task 6).
...
from hausa_numbers.exceptions import DomainError  # noqa: E402
from hausa_numbers.expressions import (  # noqa: E402
    Expression,
    evaluate,
    render_expression,
    render_result,
)
from hausa_numbers.generator import generate  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Prononce un nombre ou un résultat hausa.")
