#!/usr/bin/env python
"""Construit un corpus de benchmark **de performance** à partir de vraie parole hausa.
...
PCM16, un locuteur hausa) sont concaténés le long de chemins **valides de la
...
vraie parole hausa, et la transcription attendue est connue par construction.
...
def _sample_utterances(seed: int) -> dict[str, list[str]]:
    ...
    from hausa_numbers.grammar import load_expression_grammar
