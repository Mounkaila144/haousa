...
void main() {
  Map<String, dynamic> response({Object? expression}) {
    return <String, dynamic>{
      ...
      'hausa_text': 'ashirin da uku a ƙara goma sha biyar',
  ...
  Map<String, dynamic> expressionJson() {
    return <String, dynamic>{
      ...
      'result': 38,
      'remainder': 0,
      'result_hausa_text': 'talatin da takwas',
      'refusal_code': null,
    };
  }
  ...
  test('mappe une opération complète', () {
    final RecognitionResult result = RecognitionResult.fromLiveJson(
      response(expression: expressionJson()),
    );
  ...
  test('conserve le reste d’une division', () {
    ...
    final RecognizedExpression expression = RecognitionResult.fromLiveJson(
      response(expression: json),
    ).expression!;
