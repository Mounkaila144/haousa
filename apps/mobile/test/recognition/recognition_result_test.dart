...
void main() {
  ...
  test('refuse décision inconnue et accept incohérent', () {
    expect(
      () =>
          RecognitionResult.fromLiveJson(_response()..['decision'] = 'unknown'),
    ...
    expect(
      () => RecognitionResult.fromLiveJson(_response()..['hausa_text'] = ' '),
      throwsA(isA<RecognitionContractException>()),
    );
  });
...
Map<String, dynamic> _response() {
  return <String, dynamic>{
    ...
    'alternatives': <dynamic>[
      <String, dynamic>{
        'number': 90,
        'hausa_text': 'alternative',
        'score': 0.7,
      },
      <String, dynamic>{'number': null, 'hausa_text': '', 'score': 0.2},
    ],
