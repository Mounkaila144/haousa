...
void main() {
  ...
  testWidgets(
    'Résultat affiche le chiffre seul, jamais la forme hausa ni les métadonnées',
    (tester) async {
  ...
  await tester.pumpWidget(
    ProviderScope(
      overrides: <Override>[
        ...
        hausaSpeakerProvider.overrideWithValue(null),
      ],
      child: MaterialApp(
        routes: _routesWithoutHome(),
...
RecognitionResult _result(Decision decision) => RecognitionResult(
  ...
  hausaText: decision == Decision.accept ? 'ashirin da biyu' : '',
  normalizedText: '',
  confidence: 0.95,
  decision: decision,
  modelVersion: 'mock',
