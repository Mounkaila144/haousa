...
void main() {
  ...
  test('envoie uniquement anon_id et valide le reçu générique', () async {
    ...
    expect(captured[0], <String, dynamic>{'anon_id': _anonId});
  ...
  test('rejette un reçu incomplet, enrichi ou au mauvais statut', () async {
    ...
    await expectInvalid(<String, dynamic>{'status': 'withdrawn', 'count': 2});
  ...
  for (final MapEntry<DioExceptionType, ContributionWithdrawalFailureType>
      mapping
