...
class _FakeGenerator implements HausaGeneratorRepository {
...
void main() {
  ...
  test('résout forme, version et catégorie sans règle Dart', () async {
    ...
    expect(prompt.expectedPrompt, 'ɗari');
    expect(prompt.grammarVersion, '1.1.0');
    expect(prompt.category, ContributionPromptCategory.asrConfusion);
  });

  for (final MapEntry<GenerationFailureType, ContributionPromptFailureType>
      scenario
