...
void main() {
  ...
  test(
    'poste un multipart WAV exact sans base64 ni champ local sensible',
    () async {
      when(
        () => dio.post<dynamic>(
          any(),
      ...
      expect(Map<String, String>.fromEntries(body.fields), <String, String>{
        'consent_id': '11111111-1111-4111-8111-111111111111',
        'anon_id': '00000000-0000-4000-8000-000000000042',
        'expected_number': '42',
        'expected_prompt': 'ashirin da biyu',
...
PendingContribution _pending(String path, {bool optionalMetadata = true}) {
  return PendingContribution(
    ...
    expectedNumber: 42,
    expectedPrompt: 'ashirin da biyu',
