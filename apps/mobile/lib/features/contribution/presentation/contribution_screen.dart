...
class _ContributionScreenState extends ConsumerState<ContributionScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final ContributionController controller = ref.read(
      contributionControllerProvider.notifier,
    );
...
class _ContributionContent extends StatelessWidget {
  const _ContributionContent({required this.state, required this.controller});
...
class _RecordingStep extends StatelessWidget {
  const _RecordingStep({required this.state, required this.controller});
...
class _ActiveRecording extends StatelessWidget {
  const _ActiveRecording({required this.state, required this.onStop});
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      liveRegion: true,
      label:
          'Micro actif. ${_formatDuration(state.elapsed)}. '
