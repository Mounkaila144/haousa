...
class ConsentFailure implements Exception {
  const ConsentFailure({required this.type, required this.message});
...
class DioConsentRepository implements ConsentRepository {
  ...
  Future<ConsentContent> fetchCurrent({
    ...
    try {
      final Response<dynamic> response = await _dio.get<dynamic>(
        '/consent',
        queryParameters: anonId == null
            ? null
            : <String, dynamic>{'anon_id': anonId},
  ...
  Future<ConsentAcceptance> accept({
    ...
    try {
      ...
      final ConsentAcceptance receipt = ConsentAcceptance.fromJson(
