...
class ContributionPromptSeed {
  const ContributionPromptSeed({required this.number, required this.category});

  final int number;
  final ContributionPromptCategory category;
}

/// Catalogue de nombres uniquement : aucune règle nombre→hausa n'est dupliquée
...
final contributionPromptSourceProvider = Provider<ContributionPromptSource>((
  ref,
) {
