...
/// tient de `hausa_numbers`. Ce fichier ne fait que **choisir quoi montrer**,
...
/// |-------------|------------------------------------------|---------------------------|
/// | `answered`  | résultat exact                           | le nombre + sa forme hausa |
...
class CalculationView {
  ...
  /// résultat se prononce depuis la forme hausa renvoyée par le serveur — jamais
  /// recomposée ici.
    ...
    switch (outcome) {
      ...
      case CalculationOutcome.remainder:
        return '$operation Résultat ${expression.result}, '
            'reste ${expression.remainder}. En hausa : $resultHausaText.';
      case CalculationOutcome.answered:
        return '$operation Résultat ${expression.result}. '
            'En hausa : $resultHausaText.';
    }
  }
}
