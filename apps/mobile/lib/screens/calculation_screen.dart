...
/// le calcul vient du serveur, et l'assemblage audio de [HausaSpeaker]. Rien
  ...
  Future<void> _speakLoop(
    ...
    while (mounted && version == _loopVersion) {
      ...
      if (outcome != SpeechOutcome.spoken) {
        return; // répéter une panne de synthèse n'aiderait personne
      }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              if (_lastOutcome != null && _lastOutcome != SpeechOutcome.spoken)
                Padding(
