...
def test_mock_text_is_returned_when_configured():
    ...
    settings = Settings(ASR_MODE="mock", ASR_MOCK_TEXT="ashirin da uku")
    recognizer = get_recognizer(settings)
    assert recognizer.transcribe(AudioInput(data=b"", format="wav")).text == ("ashirin da uku")
