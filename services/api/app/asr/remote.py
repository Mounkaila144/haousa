...
class RemoteCtcRecognizer(_RemoteRecognizer):
    """Reconnaissance Hausa distante via le modele NCAIR configure."""

    _MODEL_NAME = "NCAIR1/Hausa-ASR"
    _LANG = None


class RemoteLlmRecognizer(_RemoteRecognizer):
    """Alias de compatibilite de l'ancien mode, route vers le meme modele Hausa."""
