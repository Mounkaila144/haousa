...
de vérité de la version de grammaire est le lexique (``hausa_numbers``), exposée
...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "sqlite+aiosqlite:///./hausa.db"
    ...
    MOBILE_PLAY_STORE_URL: str = (
        "https://play.google.com/store/apps/details?id=ne.hausa.hausa_mobile"
    )
